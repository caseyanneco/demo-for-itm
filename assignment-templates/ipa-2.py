...
def shift_by_letter(letter, letter_shift):
    ...
    letter_ascii = ord(letter) - ord('a')
    shift_by_ascii = ord(letter_shift) + ord('a')

    shifted_ascii = (letter_ascii + shift_by_ascii) % 26
...
def scytale_decipher(message, shift):
    ...
    if message_length % shift != 0:
        raise ValueError("Invalid message. The length of the message is not a multiple of the shift.")
    decoded_message = ''
